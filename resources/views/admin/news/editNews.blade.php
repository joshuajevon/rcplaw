...
@section('body')
    <div class="flex">
        ...
        <div
            ...
            <h1 class="text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-outfit font-medium">Perbarui Artikel</h1>

            <form
                class="w-full  p-8  flex flex-col justify-center items-start gap-6"
                action="{{ route('updateNews', $news->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="w-full">
                ...
                <div class="w-full">
                    ...
                    <img src="{{ asset('/storage/news/'.$news->image) }}" style="width: 30rem" alt="">
                ...
                <div class="w-full">
                    ...
                    <textarea name="description" id="description" cols="30" class="mt-1 w-full font-cormorant font-bold p-4 border border-black rounded-md text-sm sm:text-base" rows="10">{{ $news->description }}</textarea>
                ...
                <button type="submit" class="bg-gold py-2 rounded-full px-12 font-cormorant font-bold">Perbarui Artikel</button>
            </form>
        </div>
    </div>
@endsection
