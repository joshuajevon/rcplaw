<footer id="footer" class="custom-container bg-customDarkGray text-white pb-4 pt-8 md:pt-12 xl:pt-16 flex flex-col items-center justify-center gap-12 md:gap-14 xl:gap-16">
    ...
    <div class="flex flex-col md:flex-row items-start sm:items-center justify-center gap-4 md:gap-6 xl:gap-16 text-[10px] md:text-xs text-white">
        <a class="transition hover:text-gold flex items-center gap-2" href="tel:021-5222-289" target="_blank" rel="noreferrer noopener">
            <svg class="size-4 md:size-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
        ...
        <a class="transition hover:text-gold flex items-center sm:items-center gap-2" href="https://www.google.com/maps?ll=-6.211448,106.829908&z=18&t=m&hl=en&gl=ID&mapclient=embed&q=Wisma+Kodel+Jl.+H.+R.+Rasuna+Said+RT.10/RW.7,+Kuningan,+Setia+Budi+Kecamatan+Setiabudi,+Kota+Jakarta+Selatan,+Daerah+Khusus+Ibukota+Jakarta+12920" target="_blank" rel="noreferrer noopener">
            <svg class="w-[18px] h-[18px] md:size-5" viewBox="0 0 12 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="transition hover:text-gold flex items-start sm:items-center gap-2" href="https://www.instagram.com/rcp.law/" target="_blank" rel="noreferrer noopener">
