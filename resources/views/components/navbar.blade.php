<nav class="flex flex-col fixed w-full bg-white z-50">
    ...
    <div class="custom-container border-b border-b-gold flex flex-col xl:flex-row justify-between items-center py-2 text-sm gap-2">
        ...
        <div class="flex gap-4 md:gap-6 xl:gap-8 font-semibold items-center">
            ...
            <a class="transition hover:text-gold" href="tel:021-5222-289" target="_blank" rel="noreferrer noopener">
                <svg class="size-3 md:size-3.5 xl:size-4" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
            ...
            <a class="transition hover:text-gold" href="https://www.instagram.com/rcp.law/" target="_blank" rel="noreferrer noopener">
                <svg class="size-3 md:size-3.5 xl:size-4" viewBox="0 0 12 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {{-- NAVIGATION --}}
    <div class="custom-container py-2 md:py-3 xl:py-4 flex justify-between items-center">
        <div>
