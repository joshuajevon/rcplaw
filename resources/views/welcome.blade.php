...
<div class="bg-[#EDEDED] font-outfit *:text-customDarkGray">
    ...
    <section id="beranda" class="flex flex-col gap-5 sm:gap-24 md:gap-28 xl:gap-32 pt-32 sm:pt-40 md:pt-44 xl:pt-48 pb-12 md:pb-16 xl:pb-20">
        <div class="animated-section custom-container flex justify-between items-center gap-0 sm:gap-8 md:gap-6 xl:gap-16">
            ...
            <div class="flex mt-4 justify-center w-0 sm:w-full h-80 md:h-96 xl:h-[28rem] overflow-clip">
                ...
                <div class="ml-2 duration-500 ease-in-out flex-none lg:flex-auto group transition-all h-full overflow-hidden w-20 lg:w-1/5 hover:w-64 lg:hover:w-96 shadow-lg rounded-xl lg:rounded-2xl relative">
                    ...
                    <img class="object-cover h-full w-full brightness-50" src="{{asset('assets/beranda/hukum-kekeluargaan-dan-waris-islam.png')}}" alt="hukum-kekeluargaan-dan-waris-islam">
                </div>
            </div>
        </div>

        <div class="flex animated-section flex-col gap-6 md:gap-7 xl:gap-8">
            <p class="uppercase paragraph font-semibold text-center custom-container">Dipercaya oleh banyak Client di Indonesia</p>

            <div class="w-full inline-flex flex-nowrap overflow-hidden">
                <ul class="flex items-center [&_li]:mx-2 [&_li]:md:mx-3.5 [&_li]:xl:mx-4 [&_img]:max-w-none animate-infinite-scroll-left">
                    @for($i = 1; $i
                    <= 16; $i++) <li>
    ...
    {{-- TENTANG KAMI --}}
    <section id="tentang-kami" class=" py-12 md:py-16 xl:py-20 custom-container flex flex-col items-center">
        <div class="flex flex-col items-center animated-section">
        ...
        <div class="animated-section flex justify-center gap-3 sm:gap-4 md:gap-8 xl:gap-16 mt-2 md:mt-4 md:items-center *:flex-none w-full">
            <div class="flex flex-col items-center gap-2 group w-1/6">
                ...
                <p class="paragraph1 group-hover:text-gold transition text-center">> 10 Tahun</p>
            </div>
            ...
            <div class="flex flex-col items-center gap-2 group group w-1/6">
                ...
                <p class="paragraph1 group-hover:text-gold transition text-center">Solusi Terbaik</p>
            </div>
            ...
            <div class="flex flex-col items-center gap-2 group group w-1/6">
                ...
                <p class="paragraph1 group-hover:text-gold transition text-center">Efisien & Efektif</p>
            </div>
            ...
            <div class="flex flex-col items-center gap-2 group group w-1/6">
                ...
                <p class="paragraph1 group-hover:text-gold transition text-center">Memahami Klien</p>
            </div>
            ...
            <div class="flex flex-col items-center gap-2 group group w-1/6">
                ...
                <p class="paragraph1 group-hover:text-gold transition text-center">Berbagai Bidang</p>
            </div>
        </div>
    </section>

    {{-- LAYANAN KAMI --}}
    <section id="layanan-kami" class="py-12 md:py-16 xl:py-20 custom-container flex flex-col gap-8 md:gap-16 xl:gap-24">
        <div class="flex flex-col md:flex-row items-center">
            <div class="pb-2 md:pe-8 mb-4 md:mb-0 md:me-8 border-b md:border-b-0 md:border-e border-b-customDarkGray md:border-e-customDarkGray md:py-4 flex-none w-fit">
                <h1 class="heading-1 font-cormorant font-bold animated-section">Layanan Kami</h1>
            </div>

            <p class="text-xs md:text-sm leading-loose text-justify md:text-start mx-2 animated-section">RCP menjunjung tinggi reputasi terpercaya dengan memahami minat klien dan bekerja sama untuk mencapai tujuan yang diinginkan. Tujuan firma kami adalah untuk membangun hubungan jangka panjang dengan klien kami dengan menyediakan layanan hukum berkualitas tinggi yang efektif dan efisien untuk klien.</p>
        </div>

        <div class="grid grid-cols-4 gap-y-8 md:gap-y-12 xl:gap-y-16 font-medium animated-section">
            <div class="flex justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-2 sm:gap-4 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-10 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 110 111" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 class="paragraph1 group-hover:text-gold transition text-center leading-loose">Hukum Pidana</h5>
                </span>
            </div>

            <div class="flex justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-2 sm:gap-4 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-9 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 84 84" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 class="paragraph1 group-hover:text-gold transition text-center leading-loose">Hukum Korporasi
                        dan Bisnis</h5>
                </span>
            </div>
            ...
            <div class="flex justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-2 sm:gap-4 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-9 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 85 85" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 class="paragraph1 group-hover:text-gold transition text-center leading-loose">Hukum Pertahanan</h5>
                </span>
            </div>

            <div class="flex justify-center px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-2 sm:gap-4 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-9 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 97 79" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 class="paragraph1 group-hover:text-gold transition text-center leading-loose">Hukum Keluarga</h5>
                </span>
            </div>

            <div class="flex justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-2 sm:gap-4 text-lg items-center  group">
                    <svg class="size-9 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 91 81" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 class="paragraph1 group-hover:text-gold transition text-center leading-loose">Penyelesaian
                        Sengketa</h5>
                </span>
            </div>
            ...
            <div class="flex justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-2 sm:gap-4 text-lg items-center group">
                    <svg class="size-9 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 86 85" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 class="paragraph1 group-hover:text-gold transition text-center leading-loose">Hukum Kekayaan
                        Intelektual</h5>
                </span>
            </div>

            <div class="flex justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-2 sm:gap-4 text-lg items-center group h-max">
                    <svg class="size-9 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 84 69" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 class="paragraph1 group-hover:text-gold transition text-center leading-loose">Sengketa Hasil
                        Pemilihan Umum</h5>
                </span>
            </div>

            <a href="{{route("layanan-kami")}}" class="flex justify-center px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-2 sm:gap-4 text-lg items-center  group">
                    <svg class="size-7 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox=" 0 0 52 45" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 class="paragraph1 group-hover:text-gold transition text-center">Selengkapnya</h5>
                </span>
            </a>
        </div>
    </section>
        ...
        <div class="flex flex-col items-center gap-8 md:gap-12 xl:gap-16">
            ...
            <div class="flex flex-col items-center sm:items-end gap-4 md:gap-12 xl:gap-16">
                <div class="flex-col sm:flex sm:flex-row gap-6 md:gap-7 xl:gap-8">
                    ...
                    <div class="*:font-cormorant font-bold">
                        <p class="paragraph text-gold text-center sm:text-end mt-2">Partner</p>
            ...
            <div class="animated-section flex items-center justify-center gap-x-8 md:gap-x-12 xl:gap-x-16 gap-y-4 md:gap-y-8 xl:gap-y-12 flex-wrap">
            ...
            <a href="{{route('tim-kami')}}" class="animated-section paragraph flex items-center gap-1 md:gap-1.5 xl:gap-2 hover:text-gold transition">
                Selengkapnya
    ...
    <section id="artikel" class="py-12 md:py-16 xl:py-20 custom-container flex flex-col gap-8 md:gap-16 xl:gap-24">
        <div class="flex flex-col md:flex-row items-center animated-section">
            <div class="pb-2 md:pe-8 mb-4 md:mb-0 md:me-8 border-b md:border-b-0 md:border-e border-b-customDarkGray md:border-e-customDarkGray md:py-4 flex-none w-fit">
    ...
    <section id="kontak" class="py-12 md:py-16 xl:py-20 custom-container flex flex-col items-center gap-4 md:gap-6 xl:gap-8">
        ...
        <div class="bg-customDarkGray flex w-full border border-gold">
            ...
            <div class="flex flex-col gap-6 md:gap-7 xl:gap-8 w-full px-6 md:px-7 xl:px-8 pb-4 md:pb-6 xl:pb-8 pt-8 md:pt-12 xl:pt-16">
                <div class="text-white flex flex-col gap-2 animated-section">
                ...
                <form action="{{ route('contact') }}" method="POST" class="animated-section flex flex-col gap-4 md:gap-6 xl:gap-8 w-full" onsubmit="contactUs(event)" id="form-contact-us">
                    @csrf
                ...
                <div class="flex justify-between items-center gap-4 mt-8 md:mt-12 xl:mt-16">
                    <div class="flex gap-y-3 gap-x-6 md:gap-x-7 xl:gap-x-8 text-white flex-wrap">
                        <a class="transition hover:text-gold flex items-center gap-2" href="tel:021-5222-289" target="_blank" rel="noreferrer noopener">
                            <svg class="size-4 md:size-5 xl:size-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                                <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.6 17.6 0 0 0 4.168 6.608 17.6 17.6 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.68.68 0 0 0-.58-.122l-2.19.547a1.75 1.75 0 0 1-1.657-.459L5.482 8.062a1.75 1.75 0 0 1-.46-1.657l.548-2.19a.68.68 0 0 0-.122-.58zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z" />
                            </svg>

                            <p class="paragraph">+62 21-5222-289</p>
                        </a>
