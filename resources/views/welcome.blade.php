    ...
    <section id="tentang-kami" class="py-12 md:py-16 xl:py-20 custom-container flex flex-col items-center">
        ...
        <div class="flex justify-center gap-3 sm:gap-4 md:gap-8 xl:gap-16 items-center *:flex-none w-full">
            ...
            <div class="flex flex-col items-center gap-2 group group w-1/6">
                ...
                <p class="paragraph group-hover:text-gold transition text-center">Berbagai Bidang</p>
            </div>
        </div>
    </section>
    ...
    <section id="layanan-kami" class="py-12 md:py-16 xl:py-20 custom-container flex flex-col gap-8 md:gap-16 xl:gap-24">
        ...
        <div class="grid grid-cols-4 gap-y-8 md:gap-y-12 xl:gap-y-16 font-medium">
            <div class="flex items-center justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-3 md:gap-3.5 xl:gap-4 text-lg items-center group">
            ...
            <div class="flex items-center justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-3 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-10 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 84 84" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-3 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-10 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 85 85" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-3 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-10 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 97 79" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-4 text-lg items-center  group">
                    <svg class="size-10 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 91 81" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-4 text-lg items-center group">
                    <svg class="size-10 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 86 85" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-4 text-lg items-center group h-max">
                    <svg class="size-10 sm:size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 84 69" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="{{route("layanan-kami")}}" class="flex items-center justify-center px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-4 text-lg items-center  group">
                    <svg class="size-8 md:size-10 xl:size-12 group-hover:text-gold transition" viewBox=" 0 0 52 45" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 class="paragraph group-hover:text-gold transition text-center">Selengkapnya</h5>
                </span>
            </a>
        </div>
    </section>
