        ...
        <div class="grid grid-cols-4 gap-y-8 md:gap-y-12 xl:gap-y-16 font-medium">
            <div class="flex items-center justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-3 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 110 111" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-3 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 84 84" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-3 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 85 85" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-3 md:gap-3.5 xl:gap-4 text-lg items-center group">
                    <svg class="size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 97 79" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center border-r border-customDarkGray px-4 md:px-6 xl:px-8">
                <span class="flex flex-col gap-4 text-lg items-center  group">
                    <svg class="size-12 md:size-16 xl:size-20 group-hover:text-gold transition" viewBox="0 0 91 81" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
